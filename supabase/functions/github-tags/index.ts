...
const FUNCTION_NAME = "github-tags";
...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`[${FUNCTION_NAME}][${requestId}] Fetching tags for ${owner}/${repo}`);
    ...
    console.log(`[${FUNCTION_NAME}][${requestId}] Returning ${data.length} tags`);
