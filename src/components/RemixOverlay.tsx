  ...
  const runAnimation = useCallback(() => {
    ...
    const tLoop = setTimeout(
      ...
      (PHASE_DURATIONS.idle +
        PHASE_DURATIONS.phase1 +
        PHASE_DURATIONS.phase2 +
        PHASE_DURATIONS.phase3 +
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div className="relative w-[500px] h-[430px] bg-zinc-950 rounded-2xl border border-zinc-800 overflow-hidden shadow-2xl">
          {/* TUTORIAL badge */}
